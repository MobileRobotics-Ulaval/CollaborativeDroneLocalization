...
#include <cube_dot_finder/DotFinderConfig.h>
...
public:
  ...
  void dynamicParametersCallback(cube_dot_finder::DotFinderConfig &pConfig, uint32_t pLevel);
...
private:
  ...
  dynamic_reconfigure::Server<cube_dot_finder::DotFinderConfig> dynamicReconfigServer; //!< The dynamic reconfigure server
  dynamic_reconfigure::Server<cube_dot_finder::DotFinderConfig>::CallbackType dynamicReconfigCallback; //!< The dynamic reconfigure callback type
